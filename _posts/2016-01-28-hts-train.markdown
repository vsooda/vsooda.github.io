...
![image](http://vsooda.github.io/assets/hts_train/mlf.png =500x)

* 将这里的-B去掉，从而获得非二进制文件  
![image](http://vsooda.github.io/assets/hts_train/storage.png =500x)

* context hmm名：  
![image](http://vsooda.github.io/assets/hts_train/fullcontext_model_name.png =500x)
